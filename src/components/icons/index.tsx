...
function StickyNoteIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
...
export { CalendarIcon, LockIcon, PlusIcon, SaveIcon, SettingsIcon, ShareIcon, StickyNoteIcon, TimerIcon, TrashIcon, BombIcon }